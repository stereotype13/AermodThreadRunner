...
public class AermodProcessLinux implements AermodProcess, Runnable, Updateable {
	...
	public void sayProgress() {
		System.out.println(mProcessDirectory.split("/")[2] + " is " + this.mProgress + "% complete.");
	}
	...
	public void runProcess() {
		System.out.println(mProcessDirectory.split("/")[2] + " is running!");
		...
		try {
			...
			System.out.println("Exit value for " + mProcessDirectory.split("/")[2] + ": " + aermodProcess.exitValue());
			aermodProcess.destroy();
			mAermodCallback.onThreadComplete(this, mProcessDirectory.split("/")[2]);

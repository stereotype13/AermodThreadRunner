...
public class AermodProcessWindows implements AermodProcess, Runnable, Updateable {
	...
	public AermodProcessWindows(AermodCallback aermodCallback, String processDirectory) {
		this.mAermodCallback = aermodCallback;
		this.mProcessDirectory = processDirectory;
	}

	public AermodProcessWindows(AermodCallback aermodCallback, String processDirectory, int iterations) {
		this.mAermodCallback = aermodCallback;
		this.mProcessDirectory = processDirectory;
	...
	public void sayProgress() {
		System.out.println(mProcessDirectory + " is " + this.mProgress + "% complete.");
	}
	...
	public void runProcess() {
		System.out.println(mProcessDirectory + " is running!");
		Process aermodProcess;
		String output;
		String[] cmdarray = {"aermod.exe"};
		try {
			...
			System.out.println("Exit value for " + mProcessDirectory + ": " + aermodProcess.exitValue());
			aermodProcess.destroy();
			mAermodCallback.onThreadComplete(this, mProcessDirectory);

...
public class AermodThreadAppWindows implements ThreadApp {
	...
	public AermodThreadAppWindows(int threadIterations, DirectoryFinder directoryFinder, ThreadBus threadBus, AWSShutdownProcess awsShutdownProcess) {
	...
	public void execute() {
		...
		for(String directory : directoryList) {
			...
			AermodProcess aermodThread = new AermodProcessWindows((AermodCallback)mBus, directory, mThreadIterations);

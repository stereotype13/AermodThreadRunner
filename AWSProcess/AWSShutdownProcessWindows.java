...
public class AWSShutdownProcessWindows implements AWSShutdownProcess, Runnable {
	private Thread mAWSShutdownThread;
	public AWSShutdownProcessWindows() {}
	...
	public void run() {
		...
		try {
			...
			awsProcess = Runtime.getRuntime().exec("aws.exe");
